      ...
      <header className="bg-dark-bg border-b border-dark-color px-8 py-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-dark-secondary mt-1">Kelola informasi profil administrator</p>
          </div>
          ...
          <div className="dark-card">
            <div className="flex items-center space-x-6 mb-8">
              ...
              <div>
                ...
                <p className="text-dark-secondary mb-2">Administrator Rumah Sakit</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-dark-primary">+62 21 1234 5678</p>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-dark-secondary">Lokasi</p>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-dark-primary">Januari 2024</p>
                  </div>
                </div>
              </div>
            </div>
